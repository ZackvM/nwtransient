...
class pagebuilder { 
  ...
  private $registeredPages    = array('root','newsearch','howtousetidal','contactus','searchresults','definerequest');  
  //THE SECURITY EXCPETIONS ARE THOSE PAGES THAT DON'T REQUIRE USER RIGHTS TO ACCESS
  private $securityExceptions = array('root','newsearch','howtousetidal','contactus','searchresults','definerequest');
